...
oepoll = OEPoll(cl)
call = cl
creator = ["u365dcc675c51b4727bb157da44531dba"]
owner = ["u365dcc675c51b4727bb157da44531dba"]
admin = ["u365dcc675c51b4727bb157da44531dba"]
staff = ["u365dcc675c51b4727bb157da44531dba"]
...
wait = {
    ...
    "comment":"Like like & like by ☬ ɢʟᴀᴅɪᴀᴛᴏʀ ᴄʏʙᴇʀ ᴘʀᴏᴛᴇᴄᴛ ☬ ",
    "comment1":"Like like & like by ☬ ɢʟᴀᴅɪᴀᴛᴏʀ ᴄʏʙᴇʀ ᴘʀᴏᴛᴇᴄᴛ ☬",
    "message":"тᴇяıмᴀ кᴀsıн suᴅᴀн ᴀᴅᴅ sᴀʏᴀ \nвʏ.☬ ɢʟᴀᴅɪᴀᴛᴏʀ ᴄʏʙᴇʀ ᴘʀᴏᴛᴇᴄᴛ ☬ \nhttp://line.me/ti/p/YrBvjuZ4kQ",
}
protect = {
    "pqr":[],
    "pinv":[],
...
def help():
    ...
    key = key.title()
    helpMessage = "      ⟦▬▬▬▬⟦ஜ۩۞۩ஜ⟧▬▬▬▬⟧\n"
    helpMessage += "╔════۩ই  .͜͡☣͜͡✪ ᴍᴇɴᴜ ™ԌҪҏ°✪͜͡☣͜͡. ই۩═══\n"
    ...
    num = (num+1)
    helpMessage += "║☯➸ %i. " % num + key + "Addfriend •nama•\n"
    num = (num+1)
    helpMessage += "║☯➸ %i. " % num + key + "Delfriend •nama•\n"
    num = (num+1)
    ...
    num = (num+1)    
    helpMessage += "║ " + "      ────────\n"
    helpMessage += "║ " + "━[ ☬ ɢʟᴀᴅɪᴀᴛᴏʀ ᴄʏʙᴇʀ ᴘʀᴏᴛᴇᴄᴛ ☬]━\n"
    helpMessage += "╚══════════════"
    helpMessage += " Creator: http://line.me/ti/p/YrBvjuZ4kQ \n"
    return helpMessage
...
def helpbot():
    ...
    key = key.title()
    helpMessage2 = "      ▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬\n"
    helpMessage2 += "╔═☬ ɢʟᴀᴅɪᴀᴛᴏʀ ᴄʏʙᴇʀ ᴘʀᴏᴛᴇᴄᴛ ☬══\n"
    ...
    helpMessage2 += "║" + "─☬ ɢʟᴀᴅɪᴀᴛᴏʀ ᴄʏʙᴇʀ ᴘʀᴏᴛᴇᴄᴛ ☬─\n"
    helpMessage2 += "╚══════════════"
    helpMessage2 += " My ID LINE : http://line.me/ti/p/YrBvjuZ4kQ \n"
    return helpMessage2
                ...
                if msg.contentType == 13:
                    if wait["afriend"]==True:
                        ...
                        if msg.contentMetadata["mid"] in org["Friend"]:
                            ...
                            with open('org.json', 'w') as fp:
                                json.dump(org, fp, sort_keys=True, indent=4)
                            cl.sendMessage(msg.to,"Hapus teman")
                            wait["dfriend"]=False
                        else:
                            cl.sendMessage(msg.to,"Teman tidak di temukan")
                            wait["dfriend"]=False
              ...
              if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                  ...
                  try:
                      if op.param3 not in wait["blacklist"]:
                          ...
                          cl.sendMessage(op.param1, "Jangan di cancel goblok")
                  except:
                      try:
                          if op.param3 not in wait["blacklist"]:
                              kk.kickoutFromGroup(op.param1,[op.param2])
        ...
        if op.type in [25, 26]:           
            ...
            if isValid != False:
                ...
                if receiver in temp_flood:
                    if temp_flood[receiver]["expire"] == False:
...
#===========BOT UPDATE============#
                         ...
                         if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ki.sendMessage(msg.to, "☬ ɢʟᴀᴅɪᴀᴛᴏʀ ᴄʏʙᴇʀ ᴘʀᴏᴛᴇᴄᴛ ☬")
                               kk.sendMessage(msg.to, "☬ ɢʟᴀᴅɪᴀᴛᴏʀ ᴄʏʙᴇʀ ᴘʀᴏᴛᴇᴄᴛ ☬")
                               kc.sendMessage(msg.to, "☬ ɢʟᴀᴅɪᴀᴛᴏʀ ᴄʏʙᴇʀ ᴘʀᴏᴛᴇᴄᴛ ☬")
                               km.sendMessage(msg.to, "☬ ɢʟᴀᴅɪᴀᴛᴏʀ ᴄʏʙᴇʀ ᴘʀᴏᴛᴇᴄᴛ ☬")
                               kb.sendMessage(msg.to, "☬ ɢʟᴀᴅɪᴀᴛᴏʀ ᴄʏʙᴇʀ ᴘʀᴏᴛᴇᴄᴛ ☬")
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                             if msg.toType == 2:
                                 ...
                                 cl.sendMessage(msg.to,"「 HALOOO BROOOO」")
                                 cl.sendMessage(msg.to,"「 Sorry aim dapat mandat dari bos aim suruh ngepel ☬ ɢʟᴀᴅɪᴀᴛᴏʀ ᴄʏʙᴇʀ ᴘʀᴏᴛᴇᴄᴛ ☬")
                                 targets = []
                                 for g in gs.members:
